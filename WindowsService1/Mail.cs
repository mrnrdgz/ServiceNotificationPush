...
namespace WindowsService1
{
    class Mail
    {
        ...
        string DE = "notificacionespush.corpico@gmail.com"; //nuestro usuario de smtp
        string PASS = "nh1948os"; //nuestro password de smtp
        ...
        public bool enviaMail()
        {
            ...
            try
            {
                ...
                smtpMail.Port = 587; //le asignamos el puerto, en este caso gmail utiliza el 465, 587, 25
